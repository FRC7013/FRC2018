...
/**
 * The TToggle class implements a Toggle on the passed in button.  The {@link #updatePeriodic() }
 * method must be called each loop for this toggle in order for the toggle to track
 * each button state.  The toggle switches state on a transition from not pressed, button {@code false}
 * to pressed, button {@code true}.
 * <p>
...
public class TToggle {
     ...
     * <p>
     * If using a Stick button, use the constructor {@link #TToggle(TGameController, TStick)}
     * <br>
     * if using a Trigger as a button, use the constructor {@link #TToggle(TGameController, TTrigger)}
     * @param gameController object
     * @param button to use for the toggle
     */
     ...
     * @param gameController object
     * @param button to use for the toggle
     * @param initialState of the toggle
     */
     ...
     * The initial state will be set to {@code false}.
     * @param gameController object
     * @param stick (push) to use for the toggle
     */
     ...
     * @param gameController object
     * @param trigger to use for the toggle
     */
