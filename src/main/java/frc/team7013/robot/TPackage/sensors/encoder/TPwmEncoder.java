package frc.team7013.robot.TPackage.sensors.encoder;

import edu.wpi.first.wpilibj.Encoder;

public class TPwmEncoder extends TEncoder {
     ...
     *
     */
    public TPwmEncoder(int pwmChannelA, int pwmChannelB) {
     ...
     * otherwise.
     */
    public TPwmEncoder(int pwmChannelA, int pwmChannelB, boolean isInverted) {
        super(isInverted);
